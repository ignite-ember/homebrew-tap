class IgniteEmber < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/i/ignite-ember/ignite_ember-0.5.13.tar.gz"
  sha256 "9d1e11898b551c7cafcf3a7f8b63d68b9f0e4092509c03a9ee57ab5ace92c3fe"
  license "MIT"
  ...
  def install
    ...
    system libexec/"bin/python3.12", "-m", "pip", "install", "--prefer-binary", "ignite-ember==0.5.13"
